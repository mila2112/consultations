...
class ClientController {
    ...
    record =  async (req, res) => {
        try {
            ...
            const { lawyerId, startTime } = req.body;
            ...
            if(overlappingConsultations.length && overlappingConsultations[lawyerId] === lawyerId){
                ...
                res.send("You have successfully signed up for a consultation");
            }
